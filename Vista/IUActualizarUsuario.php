...
<h1 class="site-heading text-center text-white d-none d-lg-block">
  <span class="site-heading-upper text-primary mb-3">Actualizar Usuario</span>
 <!--  <span class="site-heading-lower">Edite la Hora</span>-->
</h1>
    ...
    <form action="../Controlador/LNActualizarUsuario.php" method="post" name="   " enctype="multipart/form-data" >
       ...
       min="07:00" max="18:00" required>
        ...
        <tr>
            ...
            <button><a href="../Vista/about.php">Cancelar</button><br>
        </tr>
    </form>
    </div>
        </div>
